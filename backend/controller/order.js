...
const CreateOrder = {
    ...
    async CreateOrder(req, res) {
        const { Products, Qtd, Owner, CashPayment, Boleto, NumberCreditCard, typeCard, Cvv, QtdParcelas, cpf, validade } = req.body;
    ...
    async UpdateOrder(req, res) {
        const { Owner, NumberCreditCard, Total } = req.body;
